...
array_push($values,$_SERVER['REMOTE_ADDR']);
...
echo("<!--");
echo("1:".$rating_information_security_tools."<br>");
echo("2:".$rating_prevention_response."<br>");
echo("3:".$rating_detection."<br>");
echo("score:".$score);
echo("-->");
?>
...
<body>
	...
	<div id="content-wrapper"><div id="content-words"><div id="content-results" class="center-text ">
			...
			<div id="formMain" class="E center-text center-marg ">
				...
				<div id="sendMesomething" class="spacer-top-10">YES! Send me the full copy of the Cyber Threat Readiness Report when it is complete! <a href="contact_form.html" class="colorbox">CLICK HERE</a>.</div>
				<div class="spacer-top-10"></div>
