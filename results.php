			...
			<div id="formMain" class="E center-text center-marg ">
				...
				<div id="formfields" class="E">
					<div id="results">
						...
						<div id="print">
							<img src="resources/img/results_check.png" style="margin-top:28px;" />
						</div>
					</div>
				</div> 
				<div class="clear"></div>
				...
				<?php
					if($_SESSION['contest_entered'] == false) {
				?>
				<a href="email_form.php" class="colorbox"><img src="resources/img/button_send_report.png" /></a>
				<?php } else { ?>
				<a href="email_form.php" class="colorbox"><img src="resources/img/button_forward_to_friend.png" /></a>
				<?php } ?>
				<div class="spacer-top-10"></div>
				...
				<a href="http://www.logrhythm.com/Resources/RequestOnlineDemonstration.aspx" class="results-button" target="_blank"> Schedule a personalized demo</a>
				<a href="http://logrhythm.com/portals/0/resources/in_depth_demo_result_iframe.html" class="results-button" target="_blank">Watch an in-depth demo</a>
				<a href="http://www.logrhythm.com/Resources/RequestMoreInfo.aspx" class="results-button" target="_blank">Request more info</a>
				<div class="spacer-top-10"></div>

				<div id="quotes">
					<img src="resources/img/scLogo.png" />
					<img src="resources/img/logo_infotech.png" />
					<img src="resources/img/logo_gartner.png" style="margin-top:20px;margin-right:0" />
				</div>
			</div></div>
	</div></div></div>
	<!-- content end -->
